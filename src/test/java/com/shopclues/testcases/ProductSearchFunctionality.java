...
public class ProductSearchFunctionality extends BaseTest{
	...
	public void verifyProductSearchFunctionality(String browser) throws IOException {
		...
		/*
		 * hp.searchProductswithKeyword("Nike Shoes");
		 * sp.verifyThefirstProductInTheSearchResult();
		 * pdp.verifyTheproductNameInThePDP();
		 * 
		 * 
		 * hp.searchProductswithKeyword("fasttrack watch");
		 * sp.verifyThefirstProductInTheSearchResult();
		 * pdp.verifyTheproductNameInThePDP();
		 * 
		 * hp.searchProductswithKeyword("apple phones");
		 * sp.verifyThefirstProductInTheSearchResult();
		 * pdp.verifyTheproductNameInThePDP();
		 */
